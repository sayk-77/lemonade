        ...
        topBar = {
            CenterAlignedTopAppBar(
                ...
                colors = topAppBarColors(
                    containerColor = Color(android.graphics.Color.parseColor("#F9E44C")),
            ...
            when (currentStep) {
                ...
                2 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.keep_lemon,
    ...
    Box(
        ...
        Column(
            ...
            Button(
                ...
                colors = ButtonDefaults.buttonColors(containerColor = Color(android.graphics.Color.parseColor("#C3ECD2")))
            ) {
                Image(
